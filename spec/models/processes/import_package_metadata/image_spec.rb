  ...
  describe "map_physical" do
    ...
    context "a number that is not mapped" do
      it "should raise StandardError" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: nil, image_count: 10, image_num: 1, source: 'libris')
    ...
    context "The number for cover for image num 2" do
      it "should return text FrontCoverInside" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: nil, image_count: 10, image_num: 2, source: 'libris')
    ...
    context "The number for cover for image num 3" do
      it "should raise error" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: nil, image_count: 10, image_num: 3, source: 'libris')
    ...
    context "The number for cover for second to last image" do
      it "should return text BackCoverInside" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: nil, image_count: 10, image_num: 9, source: 'libris')
    ...
    context "The number for cover for last image" do
      it "should return text BackCoverOutside" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: nil, image_count: 10, image_num: 10, source: 'libris')
  ...
  describe "validate_group_name" do
    ...
    context "for a nonexisting group_name" do
      it "should raise exception" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: [], image_count: 10, image_num: 3, source: 'libris')
    ...
    context "for an existing group_name" do
      it "should return true" do
        image = ImportPackageMetadata::Image.new(dfile_api: nil, job_id: 1, group_names: ["groupName1", "groupName2"], image_count: 10, image_num: 3, source: 'libris')
  ...
  describe "fetch_metadata" do
    ...
    context "for an image with type LeftPage and content TitlePage" do
      it "should set physical to 'LeftPage' and logical to 'TitlePage'" do
        ...
        image = ImportPackageMetadata::Image.new(dfile_api: @dfile_api, job_id: 1, group_names: [], image_count: 10, image_num: 3, source: 'libris')
    ...
    context "for an image without page type" do
      it "should invalidate object" do
        ...
        image = ImportPackageMetadata::Image.new(dfile_api: @dfile_api, job_id: 999, group_names: [], image_count: 10, image_num: 1, source: 'libris')
